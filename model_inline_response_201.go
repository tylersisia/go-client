...
type InlineResponse201 struct {
	...
	// The corresponding private spend key for this address, can be used to restore along with the shared private view key
	PrivateSpendKey string `json:"privateSpendKey,omitempty"`
	// The corresponding public spend key for this address, can be used to restore a view wallet along with the shared private view key
