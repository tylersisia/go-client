...
/* 
BalanceApiService Get the balance for a specific address
...
*/
func (a *BalanceApiService) BalanceAddressGet(ctx context.Context, address string) (InlineResponse20012, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/balance/{address}"
...
/* 
BalanceApiService Get the balance for the entire wallet container
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return InlineResponse20012
*/
func (a *BalanceApiService) BalanceGet(ctx context.Context) (InlineResponse20012, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
BalanceApiService Get the balance for every address
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []InlineResponse20013
*/
func (a *BalanceApiService) BalancesGet(ctx context.Context) ([]InlineResponse20013, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
