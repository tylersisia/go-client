...
type InlineResponse400 struct {
	// A numeric code representing the error, for programmatic use. Error code mappings can be found here - https://github.com/turtlecoin/turtlecoin/blob/development/src/WalletBackend/WalletErrors.h We will endeavour to not change these mappings.
	ErrorCode int32 `json:"errorCode,omitempty"`
	// A human readable error message, for displaying to the user. It is suggested for programmers to not pattern match on these, and instead use the errorCode.
