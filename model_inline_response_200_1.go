...
type InlineResponse2001 struct {
	...
	// If the address is integrated, this will hold the integrated payment ID
	PaymentID string `json:"paymentID,omitempty"`
	// If the address is integrated, this will hold the extracted actual address. Otherwise, it will be the passed in address.
	ActualAddress string `json:"actualAddress,omitempty"`
	// The public spend key of the passed in address
	PublicSpendKey string `json:"publicSpendKey,omitempty"`
	// The public view key of the passed in address
	PublicViewKey string `json:"publicViewKey,omitempty"`
}
