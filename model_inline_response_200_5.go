...
type InlineResponse2005 struct {
	// The amount of blocks the wallet has scanned
	WalletBlockCount int32 `json:"walletBlockCount,omitempty"`
	// The amount of blocks the daemon the wallet is connected to has synced
	LocalDaemonBlockCount int32 `json:"localDaemonBlockCount,omitempty"`
	// The amount of blocks the network has
	NetworkBlockCount int32 `json:"networkBlockCount,omitempty"`
	// The amount of peers (incoming + outgoing) peers the daemon has
	PeerCount int32 `json:"peerCount,omitempty"`
	// The hashrate the last local block the daemon knows about has
	Hashrate int32 `json:"hashrate,omitempty"`
	// Whether this wallet is a view only wallet. Certain operations are illegal on a view only wallet, such as transferring.
	IsViewWallet bool `json:"isViewWallet,omitempty"`
	// The amount of subwallets in the container
	SubWalletCount int32 `json:"subWalletCount,omitempty"`
}
