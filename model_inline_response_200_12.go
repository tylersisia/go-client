...
type InlineResponse20012 struct {
	...
	Unlocked float32 `json:"unlocked,omitempty"`
	// Locked, unspendable balance. Possibly unconfirmed change, or a transaction with an unlock time specified. In atomic units.
