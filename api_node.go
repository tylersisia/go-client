...
/* 
NodeApiService Gets the node address, port, fee, and fee address
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return InlineResponse200
*/
func (a *NodeApiService) NodeGet(ctx context.Context) (InlineResponse200, *http.Response, error) {
	var (
...
/* 
NodeApiService Sets the node address and port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body


*/
func (a *NodeApiService) NodePut(ctx context.Context, body Node) (*http.Response, error) {
	var (
